1. JAVA 언어 프로그램을 분석하여 실행 결과를 쓰시오.
    ...
    정답 : 3
    ```
2. 다음 설명하는 보안위협에서 괄호에 들어갈 알맞은 답을 쓰시오.
...
18. 테스트 기법 중 그래프를 활용하여 입력 데이터 간의 관계와 출력에 영향을 미치는 상황을 체계적으로 분석한 다음 효용성이 높은 테스트 케이스를 선정하여 검사하는 기법
